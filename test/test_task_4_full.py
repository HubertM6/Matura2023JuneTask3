...
class TaskTest(unittest.TestCase):
    ...
    def test_task_four_matura_official(self):
        ...
        TaskTest.logger.log_single_test_result("test_four_three_matura_official", result == expected, duration)
        self.assertEqual(expected, result)

    def test_task_four_big(self):
        input_path = "./tests_input/big_test.txt"

        expected = (686775, 15987)
        start = time.time()
        ...
        TaskTest.logger.log_single_test_result("test_task_four_big", result == expected, duration)
        self.assertEqual(expected, result)
